...
export default function Header() {
    ...
    return (
      <>
      <nav className="relative flex flex-wrap items-center justify-between px-2 py-3 bg-secondary mb-3 ">
            ...
            <ul className="flex flex-col lg:flex-row list-none lg:ml-auto">
              <li className="nav-item">
                <a
                  ...
                  href="#pablo"
                >
                  <i className="fab fa-facebook-square text-lg leading-lg text-primary opacity-75"></i><span className="ml-2">Share</span>
                </a>
              </li>
              <li className="nav-item">
                <a
                  ...
                  href="#pablo"
                >
                  <i className="fab fa-twitter text-lg leading-lg text-primary opacity-75"></i><span className="ml-2">Tweet</span>
                </a>
              </li>
              <li className="nav-item">
                <a
                  ...
                  href="#pablo"
                >
                  <i className="fab fa-pinterest text-lg leading-lg text-primary opacity-75"></i><span className="ml-2">Pin</span>
                </a>
              </li>
            </ul>
          </div>
